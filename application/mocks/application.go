...
// MockProductRead is a mock of ProductRead interface.
type MockProductRead struct {
	ctrl     *gomock.Controller
	recorder *MockProductReadMockRecorder
}

// MockProductReadMockRecorder is the mock recorder for MockProductRead.
type MockProductReadMockRecorder struct {
	mock *MockProductRead
}

// NewMockProductRead creates a new mock instance.
func NewMockProductRead(ctrl *gomock.Controller) *MockProductRead {
	mock := &MockProductRead{ctrl: ctrl}
	mock.recorder = &MockProductReadMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductRead) EXPECT() *MockProductReadMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductRead) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductReadMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductRead)(nil).Get), id)
}
...
// MockProductPesistenceInterface is a mock of ProductPesistenceInterface interface.
type MockProductPesistenceInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProductPesistenceInterfaceMockRecorder
}

// MockProductPesistenceInterfaceMockRecorder is the mock recorder for MockProductPesistenceInterface.
type MockProductPesistenceInterfaceMockRecorder struct {
	mock *MockProductPesistenceInterface
}

// NewMockProductPesistenceInterface creates a new mock instance.
func NewMockProductPesistenceInterface(ctrl *gomock.Controller) *MockProductPesistenceInterface {
	mock := &MockProductPesistenceInterface{ctrl: ctrl}
	mock.recorder = &MockProductPesistenceInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductPesistenceInterface) EXPECT() *MockProductPesistenceInterfaceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductPesistenceInterface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductPesistenceInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPesistenceInterface)(nil).Get), id)
}

// Save mocks base method.
func (m *MockProductPesistenceInterface) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPesistenceInterfaceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
